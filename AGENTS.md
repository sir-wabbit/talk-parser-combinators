...
- Canonical repo target: `talk-parser-combinators`. Useful entrypoints: `dev project show talk-parser-combinators`, `dev build talk-parser-combinators`, `dev check talk-parser-combinators`.
- Setup-managed files are regenerated with `dev setup talk-parser-combinators`; avoid hand-editing stamped generated files.
- Configured project types: `data`.
